...
public abstract class AbstractSession implements Session {
    ...
    public ListenableFuture<PreparedStatement> prepareAsync(final RegularStatement statement) {
        ...
        ListenableFuture<PreparedStatement> prepared = prepareAsync(statement.toString(), statement.getCustomPayload());
     ...
     */
    protected abstract ListenableFuture<PreparedStatement> prepareAsync(String query, Map<String,byte[]> customPayload);
